...
public class ReplaceEntitiesTrigger : Trigger
{
    ...
    public ReplaceEntitiesTrigger(EntityData data, Vector2 offset) : base(data, offset)
    {
        ...
        {
            Logger.Log(LogLevel.Error, "KoseiHelper", $"Failed to get entity: Requested type '{data.Attr("toEntity", "Celeste.Booster")}' does not exist");
        }
        ...
        if (fromEntityType == null || toEntityType == null)
            return;
