...
gunTexture, gunshotSound, horizontalAcceleration, lifetime, machineGunMode, particleAlpha, particleType, recoilCooldown, recoilStrength, speedMultiplier, verticalAcceleration) {
    return `{
    {
        _fromLayer = "triggers",
        _name = "KoseiHelper/NemesisGunSettings",
